...
const animationViewIcon = registerIcon(
	'animation-view-icon',
	Codicon.animation,
	localize('animationViewIcon', 'View icon of the animation view.')
);

Registry.as<IViewsRegistry>(Extensions.ViewsRegistry).registerViews(
	[
		{
			id: 'workbench.view.animation',
			name: localize2('animationView.name', "动画"),
			containerIcon: animationViewIcon,
			ctorDescriptor: new SyncDescriptor(AnimationView),

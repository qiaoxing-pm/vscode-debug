 ...
 * ```
 *
 * This will be mapped to the following XML StructureEdit by ObjectCodec.
 *
 * ```javascript
 * <Object>
 ...
 * whose root is referenced by the model's root field. A tree is a StructureEdit
 ...
 *
 * In the case of a tree StructureEdit we must further avoid infinite recursion by

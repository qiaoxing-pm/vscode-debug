...
import type PanningHandler from './handler/PanningHandler.js';
...
import EdgeStyle from './style/EdgeStyle.js';
...
import { registerDefaultShapes } from './cell/register-shapes.js';
import { registerDefaultEdgeMarkers } from './geometry/edge/MarkerShape.js';
import { registerDefaultStyleElements } from './style/register.js';

...
import { getValue } from '../../util/Utils.js';
import { getNumber } from '../../util/StringUtils.js';
import {
	getBoundingBox,
	getPortConstraints,
...
import { scaleCellState, scalePointArray } from './edge/shared.js';
import type { EdgeStyleFunction } from '../../types.js';

import { ElbowConnector as ElbowConnectorFunction } from './edge/Elbow.js';
import { EntityRelation as EntityRelationFunction } from './edge/EntityRelation.js';
import { Loop as LoopFunction } from './edge/Loop.js';
import { SegmentConnector as SegmentConnectorFunction } from './edge/Segment.js';
import { SideToSide as SideToSideFunction } from './edge/SideToSide.js';
import { TopToBottom as TopToBottomFunction } from './edge/TopToBottom.js';
...
class EdgeStyle {
	...
	static ManhattanConnector: EdgeStyleFunction = (
		...
		/**
		 * Map of obstacles
		 * Helper StructureEdit to identify whether a point lies in an obstacle.
		 */
		class ObstacleMap {

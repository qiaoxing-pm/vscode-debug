...
import type { ShapeConstructor } from '../../types.js';
/**
...
declare class CellRenderer {
     ...
     */
    defaultEdgeShape: ShapeConstructor;
    /**
     * Defines the default shape for vertices.
     * @default {@link RectangleShape}.
     */
    defaultVertexShape: ShapeConstructor;
    /**
     ...
     * @since 0.16.0
     */
    protected configureOverlayShape(_state: CellState, cellOverlay: CellOverlay, overlayShape: Shape): void;
    /**

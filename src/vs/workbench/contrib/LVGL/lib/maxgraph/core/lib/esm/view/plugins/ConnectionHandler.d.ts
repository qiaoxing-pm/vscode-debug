...
import type { CellStyle, ColorValue, GraphPlugin, Listenable, MouseListenerSet } from '../../types.js';
 ...
 * @category Plugin
 */
declare class ConnectionHandler extends EventSource implements GraphPlugin, MouseListenerSet {
     ...
     */
    constructor(graph: AbstractGraph, factoryMethod?: FactoryMethod | null);
    /**
     * Hook for subclasses to change the implementation of {@link ConstraintHandler} used here.
     * @since 0.21.0
     */
    protected createConstraintHandler(): ConstraintHandler;
    /**
...
declare class ConnectionHandlerCellMarker extends CellMarker {
    ...
    constructor(graph: AbstractGraph, connectionHandler: ConnectionHandler, validColor?: ColorValue, invalidColor?: ColorValue, hotspot?: number);

 ...
 */
class LabelShape extends RectangleShape_js_1.default {
    /**
    ...
    constructor(bounds, fill, stroke, strokeWidth) {
         ...
         */
        this.imageSize = Constants_js_1.DEFAULT_IMAGESIZE;
        this.imageSrc = null;
        /**
     ...
     */
    isHtmlAllowed() {
        return super.isHtmlAllowed() && this.indicatorColor === Constants_js_1.NONE && !!this.indicatorShape;
    }
    /**
    ...
    getImageBounds(x, y, w, h) {
        ...
        const width = this.style?.imageWidth ?? Constants_js_1.DEFAULT_IMAGESIZE;
        const height = this.style?.imageHeight ?? Constants_js_1.DEFAULT_IMAGESIZE;
        ...
        return new Rectangle_js_1.default(x, y, width, height);
    }
    /**
     * Generic background painting implementation.

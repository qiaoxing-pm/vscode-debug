 ...
 */
class TriangleShape extends ActorShape_js_1.default {
    constructor() {
        super();
    }
    /**
    ...
    redrawPath(c, x, y, w, h) {
        ...
        this.addPoints(c, [new Point_js_1.default(0, 0), new Point_js_1.default(w, 0.5 * h), new Point_js_1.default(0, h)], this.isRounded, arcSize, true);
    }
}
exports.default = TriangleShape;

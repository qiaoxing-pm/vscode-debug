...
declare class MaxToolbar extends EventSource {
     ...
     */
    addItem(title?: string | null, icon?: string | null, funct?: MouseEventListener | KeyboardEventListener | null, pressedIcon?: string | null, style?: string | null, factoryMethod?: ((handler: MaxPopupMenu, cell: Cell | null, me: MouseEvent) => void) | null): HTMLImageElement | HTMLButtonElement;
    /**

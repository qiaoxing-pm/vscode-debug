...
declare class XmlCanvas2D extends AbstractCanvas2D {
     ...
     * are between 1 (opaque) and 0 (transparent).
     */
    setGradient(color1: string | null, color2: string | null, x: number, y: number, w: number, h: number, direction: DirectionValue, alpha1?: number, alpha2?: number): void;
    /**
     ...
     */
    setFontStyle(value?: number | null): void;
    /**
     ...
     */
    text(x: number, y: number, w: number, h: number, str: string | HTMLElement, align?: string | null, valign?: string | null, wrap?: boolean | null, format?: string | null, overflow?: string | null, clip?: boolean | null, rotation?: number | null, dir?: TextDirectionValue | null): void;
    /**

 ...
 */
export declare const getScaleForPageCount: (pageCount: number, graph: AbstractGraph, pageFormat?: Rectangle, border?: number) => number;
/**
 ...
 */
export declare const show: (graph: AbstractGraph, doc?: Document | null, x0?: number, y0?: number, w?: number | null, h?: number | null) => Document;
/**
 ...
 */
export declare const printScreen: (graph: AbstractGraph) => void;

...
const CellStatePreview_js_1 = __importDefault(require("../cell/CellStatePreview.js"));
 ...
 * @category Animation
 */
class Morphing extends Animation_js_1.default {
    /**
    ...
    updateAnimation() {
        ...
        const move = new CellStatePreview_js_1.default(this.graph);
        if (this.cells != null) {
    ...
    getDelta(state) {
        ...
        return new Point_js_1.default((origin.x - x) * scale, (origin.y - y) * scale);
    }
    /**
    ...
    getOriginForCell(cell = null) {
        ...
        if (result == null) {
            ...
            result = new Point_js_1.default(-t.x, -t.y);
        }
        return result;
    }
}
exports.default = Morphing;

...
import { CreateNewFontView } from './createNewFontView.js';
...
const createNewFontViewIcon = registerIcon(
	'createNewFont-view-icon',
	Codicon.createNewFont,
	localize('createNewFontViewIcon', 'View icon of the createNewFont view.')
);

Registry.as<IViewsRegistry>(Extensions.ViewsRegistry).registerViews(
	[
		{
			id: 'workbench.view.createNewFont',
			name: localize2('createNewFontView.name', "创建新字体"),
			containerIcon: createNewFontViewIcon,
			ctorDescriptor: new SyncDescriptor(CreateNewFontView),

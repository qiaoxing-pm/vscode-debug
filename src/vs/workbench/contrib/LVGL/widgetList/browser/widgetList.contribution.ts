...
import { WidgetListView } from './widgetListView.js';
...
const widgetListViewIcon = registerIcon(
	'widgetList-view-icon',
	Codicon.widgetList,
	localize('widgetListViewIcon', 'View icon of the widgetList view.')
);
	...
	[
		{
			...
			name: localize2('widgetListView.name', "组件列表"),

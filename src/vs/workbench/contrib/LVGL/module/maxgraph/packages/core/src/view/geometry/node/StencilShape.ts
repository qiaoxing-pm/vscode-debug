...
import { getValue, isNotNullish } from '../../../util/Utils.js';
import {
	ALIGN,
	DIRECTION,
	NODETYPE,
...
import type { AlignValue, ColorValue, VAlignValue } from '../../../types.js';
...
class StencilShape extends Shape {
	...
	drawShape(
		...
		// TODO: Internal StructureEdit (array of special structs?), relative and absolute

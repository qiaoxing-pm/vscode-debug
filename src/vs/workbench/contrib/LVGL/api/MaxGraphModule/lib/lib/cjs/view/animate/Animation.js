 ...
 * @category Animation
 */
class Animation extends EventSource_js_1.default {
     ...
     */
    updateAnimation() {
        this.fireEvent(new EventObject_js_1.default(InternalEvent_js_1.default.EXECUTE));
    }
    /**
    ...
    stopAnimation() {
        if (this.thread != null) {
            ...
            this.thread = null;
            this.fireEvent(new EventObject_js_1.default(InternalEvent_js_1.default.DONE));
        }
    }
}

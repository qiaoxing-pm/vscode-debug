 ...
 * @category Layout
 */
class FastOrganicLayout extends GraphLayout_js_1.default {
    constructor(graph) {
        super(graph);
        /**
    ...
    execute(parent) {
        ...
        for (let i = 0; i < this.vertexArray.length; i += 1) {
            ...
            const id = ObjectIdentity_js_1.default.get(vertex);
            this.indices[id] = i;
        ...
        this.graph.batchUpdate(() => {
            for (let i = 0; i < n; i += 1) {
                ...
                for (let j = 0; j < cells.length; j += 1) {
                    ...
                    const id = ObjectIdentity_js_1.default.get(cells[j]);
...
exports.default = FastOrganicLayout;

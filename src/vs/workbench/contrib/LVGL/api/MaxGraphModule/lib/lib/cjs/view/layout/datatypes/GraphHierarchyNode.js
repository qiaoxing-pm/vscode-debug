 ...
 * @category Layout
 */
class GraphHierarchyNode extends GraphAbstractHierarchyCell_js_1.default {
    /**
    ...
    constructor(cell) {
        ...
        this.hashCode = false;
        this.cell = cell;
        this.id = ObjectIdentity_js_1.default.get(cell);
...
exports.default = GraphHierarchyNode;

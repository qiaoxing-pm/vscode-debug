...
const MaxToolbar_js_1 = __importDefault(require("../gui/MaxToolbar.js"));
...
const gestureUtils_js_1 = require("../util/gestureUtils.js");
/**
...
class EditorToolbar {
    ...
    init(container) {
        if (container != null) {
            this.toolbar = new MaxToolbar_js_1.default(container);
            // Installs the insert function in the editor if an item is
            // selected in the toolbar
            this.toolbar.addListener(InternalEvent_js_1.default.SELECT, (sender, evt) => {
            ...
            this.editor.graph.addListener(InternalEvent_js_1.default.DOUBLE_CLICK, this.resetHandler);
            this.editor.addListener(InternalEvent_js_1.default.ESCAPE, this.resetHandler);
        }
    }
    /**
     ...
     */
    addSeparator(icon) {
        icon = icon || `${Client_js_1.default.imageBasePath}/separator.gif`;
        ...
        if (source != null &&
            ...
            try {
                ...
                if (edge.getGeometry() == null) {
                    const edgeGeometry = new Geometry_js_1.default();
    ...
    installDropHandler(img, dropHandler) {
        ...
        const loader = (evt) => {
            ...
            (0, gestureUtils_js_1.makeDraggable)(img, this.editor.graph, dropHandler, sprite);
            InternalEvent_js_1.default.removeListener(sprite, 'load', loader);
        };
    }
    /**

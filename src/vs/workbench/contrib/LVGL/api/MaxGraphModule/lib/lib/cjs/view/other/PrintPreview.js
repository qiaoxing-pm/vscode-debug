...
const TemporaryCellStates_js_1 = __importDefault(require("../cell/TemporaryCellStates.js"));
...
class PrintPreview {
    constructor(graph, scale = null, pageFormat = null, border = null, x0 = 0, y0 = 0, borderColor = null, title = 'Printer-friendly version', pageSelector = null) {
        ...
        this.pageFormat = Rectangle_js_1.default.fromRectangle(pageFormat != null ? pageFormat : graph.pageFormat);
        this.title = title;
        this.x0 = x0;
        this.y0 = y0;
    ...
    open(css = null, targetWindow = null, forcePageBreaks = false, keepOpen = false) {
        ...
        try {
            ...
            const addPage = (div, addBreak) => {
                ...
                if (isNewWindow && Client_js_1.default.IS_EDGE) {
                ...
                else if (Client_js_1.default.IS_EDGE) {
            ...
            for (let i = 0; i < vpages; i += 1) {
                ...
                for (let j = 0; j < hpages; j++) {
                    ...
                    const clip = new Rectangle_js_1.default(dx, dy, availableWidth, availableHeight);
    ...
    closeDocument() {
        try {
            if (this.wnd != null && this.wnd.document != null) {
                ...
                InternalEvent_js_1.default.release(doc.body);
            }
        }
        catch (e) {
    ...
    writeHead(doc, css) {
        ...
        (0, domUtils_js_1.addLinkToHead)('stylesheet', `${Client_js_1.default.basePath}/css/common.css`, doc);
    ...
    createPageSelector(vpages, hpages) {
        ...
        for (let i = 0; i < vpages; i += 1) {
            ...
            for (let j = 0; j < hpages; j++) {
                ...
                if (Client_js_1.default.IS_NS && !Client_js_1.default.IS_SF && !Client_js_1.default.IS_GC) {
                    const js = `let page = document.getElementById('mxPage-${pageNum}');page.scrollIntoView(true);event.preventDefault();`;
                    a.setAttribute('onclick', js);
                }
                (0, domUtils_js_1.write)(a, String(pageNum));
                cell.appendChild(a);
     ...
     */
    useCssTransforms() {
        return !Client_js_1.default.NO_FO && !Client_js_1.default.IS_SF;
    }
    /**
    ...
    addGraphFragment(dx, dy, scale, pageNumber, div, clip) {
        ...
        view.translate = new Point_js_1.default(dx, dy);
        ...
        if (this.clipping) {
            const tempClip = new Rectangle_js_1.default((clip.x + translate.x) * s, (clip.y + translate.y) * s, (clip.width * s) / realScale, (clip.height * s) / realScale);
                ...
                if (state != null) {
                    ...
                    if (orig != null) {
                        ...
                        if (bbox != null &&
                            bbox.width > 0 &&
                            bbox.height > 0 &&
                            !(0, mathUtils_js_1.intersects)(tempClip, bbox)) {
                            return;
                        }
                    }
                }
        ...
        try {
            ...
            temp = new TemporaryCellStates_js_1.default(view, scale, cells, null, (state) => {
                return this.getLinkForCellState(state);
            });
        }
        catch (e) {
            config_js_1.GlobalConfig.logger.error('PrintPreview unable to generate the preview', e);
        }
        finally {

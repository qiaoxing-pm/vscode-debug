...
exports.EditorKeyHandler = void 0;
...
const KeyHandler_js_1 = __importDefault(require("../view/handler/KeyHandler.js"));
/**
...
class EditorKeyHandler {
    constructor(editor = null) {
        ...
        if (editor != null) {
            this.editor = editor;
            const handler = (this.handler = new KeyHandler_js_1.default(editor.graph));
            ...
            this.handler.escape = (evt) => {
                ...
                editor.fireEvent(new EventObject_js_1.default(InternalEvent_js_1.default.ESCAPE, { event: evt }));
            };
        }
    }
    /**
...
exports.default = EditorKeyHandler;

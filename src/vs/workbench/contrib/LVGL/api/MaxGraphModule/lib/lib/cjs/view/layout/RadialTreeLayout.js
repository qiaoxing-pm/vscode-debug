...
const CompactTreeLayout_js_1 = require("./CompactTreeLayout.js");
/**
 ...
 * @category Layout
 */
class RadialTreeLayout extends CompactTreeLayout_js_1.CompactTreeLayout {
    constructor(graph) {
        super(graph, false);
        this.centerX = null;
        this.centerY = null;
...
exports.default = RadialTreeLayout;

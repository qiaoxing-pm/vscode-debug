 ...
 * @category Geometry
 */
declare class Geometry extends Rectangle {
     ...
     */
    getTerminalPoint(isSource: boolean): Point | null;
    /**
     ...
     */
    rotate(angle: number, cx: Point): void;
    /**
     ...
     */
    equals(geom: Geometry | null): boolean;
    clone(): Geometry;
}

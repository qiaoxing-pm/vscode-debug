 ...
 */
class DoubleEllipseShape extends Shape_js_1.default {
    ...
    getLabelBounds(rect) {
        ...
        return new Rectangle_js_1.default(rect.x + margin, rect.y + margin, rect.width - 2 * margin, rect.height - 2 * margin);
    }
}
exports.default = DoubleEllipseShape;

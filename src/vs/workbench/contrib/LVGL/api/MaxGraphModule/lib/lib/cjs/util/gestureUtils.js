...
const DragSource_js_1 = __importDefault(require("../view/other/DragSource.js"));
...
const makeDraggable = (element, graphF, funct, dragElement = null, dx = null, dy = null, autoscroll = null, scalePreview = false, highlightDropTargets = true, getDropTarget = null) => {
    const dragSource = new DragSource_js_1.default(element, funct);
    dragSource.dragOffset = new Point_js_1.default(dx != null ? dx : 0, dy != null ? dy : Constants_js_1.TOOLTIP_VERTICAL_OFFSET);
    if (autoscroll != null) {

 ...
 * ```
 */
class CellState extends Rectangle_js_1.default {
    /**
    ...
    constructor(view = null, cell = null, style = null) {
        ...
        this.style = style ?? {};
        this.origin = new Point_js_1.default();
        this.absoluteOffset = new Point_js_1.default();
    }
    /**
     ...
     */
    getPerimeterBounds(border = 0, bounds = new Rectangle_js_1.default(this.x, this.y, this.width, this.height)) {
    ...
    updateCachedBounds() {
        ...
        const s = view.scale;
        this.cellBounds = new Rectangle_js_1.default(this.x / s - tr.x, this.y / s - tr.y, this.width / s, this.height / s);
        this.paintBounds = Rectangle_js_1.default.fromRectangle(this.cellBounds);
     ...
     */
    isTransparentState() {
        return ((this.style.strokeColor ?? Constants_js_1.NONE) === Constants_js_1.NONE &&
            (this.style.fillColor ?? Constants_js_1.NONE) === Constants_js_1.NONE &&
            !this.getImageSrc());
    }
    /**

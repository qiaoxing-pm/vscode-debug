...
class Multiplicity {
    constructor(source, type, attr, value, min, max, validNeighbors, countError, typeError, validNeighborsAllowed = true) {
        ...
        this.countError = (0, i18n_utils_js_1.translate)(countError) || countError;
        this.typeError = (0, i18n_utils_js_1.translate)(typeError) || typeError;
    ...
    checkType(graph, value, type, attr, attrValue) {
        if (value != null) {
            if (typeof value !== 'string' &&
                ...
                return (0, domUtils_js_1.isNode)(value, type, attr, attrValue);
            }
            return value === type;
        }
        return false;

...
const GraphHierarchyModel_js_1 = __importDefault(require("./hierarchical/GraphHierarchyModel.js"));
const ObjectIdentity_js_1 = __importDefault(require("../../util/ObjectIdentity.js"));
const MinimumCycleRemover_js_1 = __importDefault(require("./hierarchical/MinimumCycleRemover.js"));
 ...
 * @category Layout
 */
class HierarchicalLayout extends GraphLayout_js_1.default {
    /**
    ...
    run(parent) {
        ...
        for (let i = 0; i < hierarchyVertices.length; i += 1) {
            ...
            this.model = new GraphHierarchyModel_js_1.default(this, tmp, this.roots, parent, this.tightenToSource);
     ...
     */
    cycleStage(parent) {
        const cycleStage = new MinimumCycleRemover_js_1.default(this);
...
exports.default = HierarchicalLayout;

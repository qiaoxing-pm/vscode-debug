...
exports.EditorCodec = void 0;
const ObjectCodec_js_1 = __importDefault(require("../../ObjectCodec.js"));
const Editor_js_1 = __importDefault(require("../../../editor/Editor.js"));
 ...
 */
class EditorCodec extends ObjectCodec_js_1.default {
    constructor() {
        const __dummy = undefined;
        super(new Editor_js_1.default(__dummy), [
            'modified',
            'lastSnapshot',
            'ignoredChanges',
            'undoManager',
        ...
        while (tmp != null) {
            if (tmp.nodeName === 'add') {
                ...
                if (elt != null) {
                    ...
                    const wnd = new MaxWindow_js_1.default((0, i18n_utils_js_1.translate)(as) || as, element, x, y, width ? parseInt(width) : null, height ? parseInt(height) : null, false, true);
                    wnd.setVisible(true);
                }
                ...
                config_js_1.GlobalConfig.i18n.addResource(tmp.getAttribute('basename'));
            }
            else if (tmp.nodeName === 'stylesheet') {
                (0, domUtils_js_1.addLinkToHead)('stylesheet', tmp.getAttribute('name'));
            }
            tmp = tmp.nextSibling;
        }
    }

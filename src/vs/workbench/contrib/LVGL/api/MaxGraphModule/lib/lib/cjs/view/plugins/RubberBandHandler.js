...
class RubberBandHandler {
    constructor(graph) {
        ...
        this.forceRubberbandHandler = (sender, evt) => {
            ...
            if (evtName === InternalEvent_js_1.default.MOUSE_DOWN && this.isForceRubberbandEvent(me)) {
                const offset = (0, styleUtils_js_1.getOffset)(this.graph.container);
                const origin = (0, styleUtils_js_1.getScrollOrigin)(this.graph.container);
                origin.x -= offset.x;
                origin.y -= offset.y;
        ...
        this.graph.addListener(InternalEvent_js_1.default.FIRE_MOUSE_EVENT, this.forceRubberbandHandler);
    ...
    isForceRubberbandEvent(me) {
        return (0, EventUtils_js_1.isAltDown)(me.getEvent());
    }
    /**
    ...
    start(x, y) {
        ...
        function createMouseEvent(evt) {
            const me = new InternalMouseEvent_js_1.default(evt);
            const pt = (0, styleUtils_js_1.convertPoint)(container, me.getX(), me.getY());
            me.graphX = pt.x;
            me.graphY = pt.y;
            return me;
        }
        ...
        if (Client_js_1.default.IS_FF) {
            InternalEvent_js_1.default.addGestureListeners(document, null, this.dragHandler, this.dropHandler);
        }
    }
    /**
    ...
    createShape() {
        if (!this.sharedDiv) {
            ...
            (0, styleUtils_js_1.setOpacity)(this.sharedDiv, this.defaultOpacity);
        }
        this.graph.container.appendChild(this.sharedDiv);
        const result = this.sharedDiv;
        if (Client_js_1.default.IS_SVG && this.fadeOut) {
            this.sharedDiv = null;
        }
        return result;
    }
     ...
     */
    execute(evt) {
        const rect = new Rectangle_js_1.default(this.x, this.y, this.width, this.height);
    ...
    reset() {
        if (this.div) {
            if (Client_js_1.default.IS_SVG && this.fadeOut) {
                const temp = this.div;
                (0, styleUtils_js_1.setPrefixedStyle)(temp.style, 'transition', 'all 0.2s linear');
        ...
        InternalEvent_js_1.default.removeGestureListeners(document, null, this.dragHandler, this.dropHandler);
        this.dragHandler = null;
        this.dropHandler = null;
        this.currentX = 0;
        this.currentY = 0;
...
exports.default = RubberBandHandler;

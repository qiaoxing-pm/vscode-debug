...
exports.SelectionMixin = {
    ...
    getSelectionCellsForChanges(changes, ignoreFn = null) {
        ...
        for (let i = 0; i < changes.length; i += 1) {
            ...
            if (change.constructor !== RootChange_js_1.default && (!ignoreFn || !ignoreFn(change))) {
                let cell = null;
                if (change instanceof ChildChange_js_1.default) {
                    cell = change.child;
                }
                else if (change.cell && change.cell instanceof Cell_js_1.default) {
                    cell = change.cell;
                }
                if (cell) {
                    addCell(cell);

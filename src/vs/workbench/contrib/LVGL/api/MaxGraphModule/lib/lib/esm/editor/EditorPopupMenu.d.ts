...
export declare class EditorPopupMenu {
     ...
     */
    addItems(editor: Editor, menu: MaxPopupMenu, cell: (Cell | null) | undefined, evt: (MouseEvent | null) | undefined, conditions: Record<string, boolean>, item: Element, parent?: PopupMenuItem | null): void;
    /**
     ...
     * @param evt
     */
    createConditions(editor: Editor, cell?: Cell | null, evt?: MouseEvent | null): Record<string, boolean>;
}

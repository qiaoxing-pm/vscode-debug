...
exports.ValidationMixin = {
        ...
        if (source && target) {
            ...
            if (!this.isMultigraph()) {
                ...
                if (tmp.length > 1 || (tmp.length === 1 && tmp[0] !== edge)) {
                    error += `${(0, i18n_utils_js_1.translate)(this.getAlreadyConnectedResource()) ||
    ...
    validateGraph(cell = null, context) {
        ...
        if (cell && cell.isCollapsed() && !isValid) {
            warning += `${(0, i18n_utils_js_1.translate)(this.getContainsValidationErrorsResource()) ||
    ...
    getCellValidationError(cell) {
        ...
        for (let i = 0; i < this.multiplicities.length; i += 1) {
            ...
            if (rule.source &&
                (0, domUtils_js_1.isNode)(value, rule.type, rule.attr, rule.value) &&

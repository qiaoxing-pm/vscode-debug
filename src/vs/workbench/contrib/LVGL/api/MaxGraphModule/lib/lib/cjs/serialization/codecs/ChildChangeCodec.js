...
exports.ChildChangeCodec = void 0;
const ObjectCodec_js_1 = __importDefault(require("../ObjectCodec.js"));
const ChildChange_js_1 = __importDefault(require("../../view/undoable_changes/ChildChange.js"));
 ...
 */
class ChildChangeCodec extends ObjectCodec_js_1.default {
    constructor() {
        const __dummy = undefined;
        super(new ChildChange_js_1.default(__dummy, __dummy, __dummy), ['model', 'child', 'previousIndex'], ['parent', 'previous']);
    }
    /**
    ...
    beforeDecode(dec, _node, obj) {
        if ((0, utils_js_1.isElement)(_node.firstChild)) {

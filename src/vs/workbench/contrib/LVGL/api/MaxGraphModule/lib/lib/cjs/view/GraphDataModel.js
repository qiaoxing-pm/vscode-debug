...
const CollapseChange_js_1 = __importDefault(require("./undoable_changes/CollapseChange.js"));
...
const VisibleChange_js_1 = __importDefault(require("./undoable_changes/VisibleChange.js"));
/**
 ...
 */
class GraphDataModel extends EventSource_js_1.default {
     ...
     */
    createRoot() {
        const cell = new Cell_js_1.default();
        cell.insert(new Cell_js_1.default());
        return cell;
    }
    /**
     ...
     */
    setRoot(root) {
        this.execute(new RootChange_js_1.default(this, root));
        return root;
    }
    /**
    ...
    add(parent, child, index = null) {
        if (child !== parent && parent != null && child != null) {
            ...
            this.execute(new ChildChange_js_1.default(this, parent, child, index));
    ...
    cellAdded(cell) {
        if (cell != null) {
            ...
            if ((0, mathUtils_js_1.isNumeric)(String(cell.getId()))) {
    ...
    remove(cell) {
        if (cell === this.root) {
            ...
            this.execute(new ChildChange_js_1.default(this, null, cell));
        }
        return cell;
    }
    /**
    ...
    setTerminal(edge, terminal, isSource) {
        ...
        this.execute(new TerminalChange_js_1.default(this, edge, terminal, isSource));
     ...
     */
    setValue(cell, value) {
        this.execute(new ValueChange_js_1.default(this, cell, value));
        return value;
    }
    /**
    ...
    setGeometry(cell, geometry) {
        if (geometry !== cell.getGeometry()) {
            this.execute(new GeometryChange_js_1.default(this, cell, geometry));
        }
        return geometry;
    }
    /**
    ...
    setStyle(cell, style) {
        ...
        if (style !== cell.getStyle()) {
            this.execute(new StyleChange_js_1.default(this, cell, style));
        }
    }
    /**
    ...
    setCollapsed(cell, collapsed) {
        if (collapsed !== cell.isCollapsed()) {
            this.execute(new CollapseChange_js_1.default(this, cell, collapsed));
        }
        return collapsed;
    }
    /**
    ...
    setVisible(cell, visible) {
        if (visible !== cell.isVisible()) {
            this.execute(new VisibleChange_js_1.default(this, cell, visible));
        }
        return visible;
    }
    /**
    ...
    execute(change) {
        ...
        this.fireEvent(new EventObject_js_1.default(InternalEvent_js_1.default.EXECUTE, { change }));
        // New global executed event
        this.fireEvent(new EventObject_js_1.default(InternalEvent_js_1.default.EXECUTED, { change }));
        this.endUpdate();
    }
    /**
    ...
    beginUpdate() {
        this.updateLevel += 1;
        this.fireEvent(new EventObject_js_1.default(InternalEvent_js_1.default.BEGIN_UPDATE));
        if (this.updateLevel === 1) {
            this.fireEvent(new EventObject_js_1.default(InternalEvent_js_1.default.START_EDIT));
        }
    }
    /**
    ...
    endUpdate() {
        ...
        if (this.updateLevel === 0) {
            this.fireEvent(new EventObject_js_1.default(InternalEvent_js_1.default.END_EDIT));
        }
        if (!this.endingUpdate) {
            this.endingUpdate = this.updateLevel === 0;
            this.fireEvent(new EventObject_js_1.default(InternalEvent_js_1.default.END_UPDATE, { edit: this.currentEdit }));
            try {
                if (this.endingUpdate && !this.currentEdit.isEmpty()) {
                    this.fireEvent(new EventObject_js_1.default(InternalEvent_js_1.default.BEFORE_UNDO, { edit: this.currentEdit }));
                    const tmp = this.currentEdit;
                    this.currentEdit = this.createUndoableEdit();
                    tmp.notify();
                    this.fireEvent(new EventObject_js_1.default(InternalEvent_js_1.default.UNDO, { edit: tmp }));
                }
            }
            finally {
                this.endingUpdate = false;
    ...
    createUndoableEdit(significant = true) {
        const edit = new UndoableEdit_js_1.default(this, significant);
        edit.notify = () => {
            // LATER: Remove changes property (deprecated)
            edit.source.fireEvent(new EventObject_js_1.default(InternalEvent_js_1.default.CHANGE, { edit, changes: edit.changes }));
            edit.source.fireEvent(new EventObject_js_1.default(InternalEvent_js_1.default.NOTIFY, { edit, changes: edit.changes }));
        };
        return edit;
    }
    /**
    ...
    mergeChildren(from, to, cloneAllEdges = true) {
        ...
        try {
            ...
            for (const key in mapping) {
                ...
                if (terminal != null) {
                    terminal = mapping[CellPath_js_1.default.create(terminal)];
        ...
        try {
            ...
            for (let i = 0; i < childCount; i += 1) {
                ...
                if (typeof cell.getId === 'function') {
                    ...
                    mapping[CellPath_js_1.default.create(cell)] = target;
                    // Recurses

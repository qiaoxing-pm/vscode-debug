...
class GraphLayout {
    ...
    setEdgePoints(edge, points) {
        if (edge != null) {
            ...
            if (geometry == null) {
                geometry = new Geometry_js_1.default();
    ...
    setVertexLocation(cell, x, y) {
        ...
        let result = null;
        if (geometry != null) {
            result = new Rectangle_js_1.default(x, y, geometry.width, geometry.height);
    ...
    getVertexBounds(cell) {
        ...
        if (this.useBoundingBox) {
            ...
            if (state != null && state.text != null && state.text.boundingBox != null) {
                ...
                geo = new Rectangle_js_1.default(geo.x - dx0, geo.y - dy0, geo.width + dx0 + dx1, geo.height + dy0 + dy1);
            }
        }
        if (this.parent != null) {
            const parent = cell.getParent();
        ...
        return new Rectangle_js_1.default(geo.x, geo.y, geo.width, geo.height);
    }
    /**

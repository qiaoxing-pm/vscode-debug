...
exports.ModelCodec = void 0;
const ObjectCodec_js_1 = __importDefault(require("../ObjectCodec.js"));
const GraphDataModel_js_1 = __importDefault(require("../../view/GraphDataModel.js"));
/**
 ...
 */
class ModelCodec extends ObjectCodec_js_1.default {
    constructor() {
        super(new GraphDataModel_js_1.default());

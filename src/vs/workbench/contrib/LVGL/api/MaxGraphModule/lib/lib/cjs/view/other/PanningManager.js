...
class PanningManager {
    constructor(graph) {
        ...
        const createThread = () => {
            this.scrollbars = (0, styleUtils_js_1.hasScrollbars)(graph.container);
            ...
            return window.setInterval(() => {
                ...
                if (this.scrollbars) {
                    ...
                    graph.fireEvent(new EventObject_js_1.default(InternalEvent_js_1.default.PAN));
...
exports.default = PanningManager;

...
exports.PanningMixin = {
    ...
    panGraph(dx, dy) {
        ...
        if (this.useScrollbarsForPanning && (0, styleUtils_js_1.hasScrollbars)(container)) {
            ...
            this.panDx = dx;
            this.panDy = dy;
            this.fireEvent(new EventObject_js_1.default(InternalEvent_js_1.default.PAN));
        }
    },
    scrollCellToVisible(cell, center = false) {
        ...
        if (state) {
            const bounds = new Rectangle_js_1.default(x + state.x, y + state.y, state.width, state.height);
            ...
            const tr = new Point_js_1.default(this.getView().translate.x, this.getView().translate.y);
            if (this.scrollRectToVisible(bounds)) {
                // Triggers an update via the view's event source
                const tr2 = new Point_js_1.default(this.getView().translate.x, this.getView().translate.y);
    ...
    scrollRectToVisible(rect) {
        ...
        if ((0, styleUtils_js_1.hasScrollbars)(container)) {

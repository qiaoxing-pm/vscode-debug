 ...
 * @category Layout
 */
class MinimumCycleRemover extends HierarchicalLayoutStage_js_1.default {
    /**
    ...
    execute(parent) {
        ...
        const seenNodesCopy = (0, cloneUtils_js_1.clone)(seenNodes, null, true);
...
exports.default = MinimumCycleRemover;

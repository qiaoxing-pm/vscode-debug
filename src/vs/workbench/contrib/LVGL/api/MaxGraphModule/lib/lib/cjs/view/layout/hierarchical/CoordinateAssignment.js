...
const WeightedCellSorter_js_1 = __importDefault(require("../util/WeightedCellSorter.js"));
const Point_js_1 = __importDefault(require("../../geometry/Point.js"));
const HierarchicalEdgeStyle_js_1 = __importDefault(require("../datatypes/HierarchicalEdgeStyle.js"));
/**
 ...
 * @category Layout
 */
class CoordinateAssignment extends HierarchicalLayoutStage_js_1.default {
    /**
    ...
    printStatus() {
        ...
        const logger = config_js_1.GlobalConfig.logger;
        logger.show();
    ...
    minNode(model) {
        ...
        for (let i = 0; i <= model.maxRank; i += 1) {
            ...
            for (let j = 0; j < rank[i].length; j += 1) {
                ...
                const node = rank[i][j];
                const nodeWrapper = new WeightedCellSorter_js_1.default(node, i);
    ...
    rankMedianPosition(rankValue, model, nextRankValue) {
        ...
        for (let i = 0; i < rank.length; i += 1) {
            ...
            weightedValues[i] = new WeightedCellSorter_js_1.default(currentCell);
        ...
        weightedValues.sort(WeightedCellSorter_js_1.default.compare);
    ...
    rankCoordinates(rankValue, graph, model) {
        ...
        for (let i = 0; i < rank.length; i += 1) {
            ...
            if (node.isVertex()) {
                ...
                if (node.edges != null) {
                    ...
                    config_js_1.GlobalConfig.logger.warn('edge.edges is null');
                }
        ...
        if (boundsWarning) {
            config_js_1.GlobalConfig.logger.warn('At least one cell has no bounds');
        }
    }
    /**
    ...
    setCellLocations(graph, model) {
        ...
        if (this.layout.edgeStyle === HierarchicalEdgeStyle_js_1.default.ORTHOGONAL ||
            this.layout.edgeStyle === HierarchicalEdgeStyle_js_1.default.POLYLINE ||
            this.layout.edgeStyle === HierarchicalEdgeStyle_js_1.default.CURVE) {
                    ...
                    for (let k = 0; k < 2; k += 1) {
                        if (currentRank > -1 &&
                            ...
                            for (let j = 0; j < currentCells.length; j++) {
                                const sorter = new WeightedCellSorter_js_1.default(currentCells[j], currentCells[j].getX(currentRank));
                                sortedCells.push(sorter);
                            }
                            sortedCells.sort(WeightedCellSorter_js_1.default.compare);
        ...
        if (cell.temp[0] !== 101207) {
            ...
            for (let i = 0; i < cell.edges.length; i += 1) {
                ...
                if (jettys != null) {
                    ...
                    if (this.orientation === 'north' || this.orientation === 'south') {
                        newPoints.push(new Point_js_1.default(x, y));
                        if (this.layout.edgeStyle === HierarchicalEdgeStyle_js_1.default.CURVE) {
                            newPoints.push(new Point_js_1.default(x, y + jetty));
                        }
                    }
                    else {
                        newPoints.push(new Point_js_1.default(y, x));
                        if (this.layout.edgeStyle === HierarchicalEdgeStyle_js_1.default.CURVE) {
                            newPoints.push(new Point_js_1.default(y + jetty, x));
                        }
                    }
                }
                ...
                for (let j = loopStart; cell.maxRank !== cell.minRank && j !== loopLimit; j += loopDelta) {
                    ...
                    if (this.orientation === 'north' || this.orientation === 'south') {
                        newPoints.push(new Point_js_1.default(positionX, topChannelY));
                        newPoints.push(new Point_js_1.default(positionX, bottomChannelY));
                    }
                    else {
                        newPoints.push(new Point_js_1.default(topChannelY, positionX));
                        newPoints.push(new Point_js_1.default(bottomChannelY, positionX));
                    }
...
exports.default = CoordinateAssignment;

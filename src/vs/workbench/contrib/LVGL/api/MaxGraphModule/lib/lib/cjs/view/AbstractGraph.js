...
const ImageBox_js_1 = __importDefault(require("./image/ImageBox.js"));
...
const ChildChange_js_1 = __importDefault(require("./undoable_changes/ChildChange.js"));
const GeometryChange_js_1 = __importDefault(require("./undoable_changes/GeometryChange.js"));
const RootChange_js_1 = __importDefault(require("./undoable_changes/RootChange.js"));
const StyleChange_js_1 = __importDefault(require("./undoable_changes/StyleChange.js"));
const TerminalChange_js_1 = __importDefault(require("./undoable_changes/TerminalChange.js"));
const ValueChange_js_1 = __importDefault(require("./undoable_changes/ValueChange.js"));
...
const EdgeHandler_js_1 = __importDefault(require("./handler/EdgeHandler.js"));
const VertexHandler_js_1 = __importDefault(require("./handler/VertexHandler.js"));
const EdgeSegmentHandler_js_1 = __importDefault(require("./handler/EdgeSegmentHandler.js"));
const ElbowEdgeHandler_js_1 = __importDefault(require("./handler/ElbowEdgeHandler.js"));
const _graph_mixins_apply_js_1 = require("./mixins/_graph-mixins-apply.js");
 ...
 * @category Graph
 */
class AbstractGraph extends EventSource_js_1.default {
    // ===================================================================================================================
    ...
    createEdgeHandlerInstance(state) {
        ...
        return new EdgeHandler_js_1.default(state);
    }
    /**
    ...
    createEdgeSegmentHandler(state) {
        return new EdgeSegmentHandler_js_1.default(state);
    }
    /**
    ...
    createElbowEdgeHandler(state) {
        return new ElbowEdgeHandler_js_1.default(state);
    }
    /**
    ...
    createVertexHandler(state) {
        return new VertexHandler_js_1.default(state);
    }
    // ===================================================================================================================
    ...
    constructor(options) {
         ...
         */
        this.pageFormat = new Rectangle_js_1.default(...Constants_js_1.PAGE_FORMAT_A4_PORTRAIT);
        /**
         ...
         */
        this.defaultLoopStyle = builtin_style_elements_js_1.EdgeStyle.Loop;
        /**
         ...
         */
        this.warningImage = new ImageBox_js_1.default(`${Client_js_1.default.imageBasePath}/warning${Client_js_1.default.IS_MAC ? '.png' : '.gif'}`, 16, 16);
        /**
         ...
         */
        this.alreadyConnectedResource = (0, i18n_utils_js_1.isI18nEnabled)() ? 'alreadyConnected' : '';
        /**
         ...
         */
        this.containsValidationErrorsResource = (0, i18n_utils_js_1.isI18nEnabled)()
            ? 'containsValidationErrors'
            : '';
        /** Folding options. */
        this.options = {
            foldingEnabled: true,
            collapsedImage: new ImageBox_js_1.default(`${Client_js_1.default.imageBasePath}/collapsed.gif`, 9, 9),
            expandedImage: new ImageBox_js_1.default(`${Client_js_1.default.imageBasePath}/expanded.gif`, 9, 9),
        ...
        this.getDataModel().addListener(InternalEvent_js_1.default.CHANGE, this.graphModelChangeListener);
    ...
    processChange(change) {
        ...
        else if (change instanceof ChildChange_js_1.default) {
        ...
        else if (change instanceof TerminalChange_js_1.default || change instanceof GeometryChange_js_1.default) {
            // Checks if the geometry has changed to avoid unnessecary revalidation
            if (change instanceof TerminalChange_js_1.default ||
        ...
        else if (change instanceof ValueChange_js_1.default) {
            this.view.invalidate(change.cell, false, false);
        }
        // Requires a new mxShape in JavaScript
        else if (change instanceof StyleChange_js_1.default) {
        ...
        else if (change.cell != null && change.cell instanceof Cell_js_1.default) {
    ...
    scrollPointToVisible(x, y, extend = false, border = 20) {
        ...
        if (!this.isTimerAutoScroll() &&
            (this.ignoreScrollbars || (0, styleUtils_js_1.hasScrollbars)(this.container))) {
     ...
     */
    getBorderSizes() {
        const css = (0, styleUtils_js_1.getCurrentStyle)(this.container);
        return new Rectangle_js_1.default((0, styleUtils_js_1.parseCssNumber)(css.paddingLeft) +
            (css.borderLeftStyle != 'none' ? (0, styleUtils_js_1.parseCssNumber)(css.borderLeftWidth) : 0), (0, styleUtils_js_1.parseCssNumber)(css.paddingTop) +
            (css.borderTopStyle != 'none' ? (0, styleUtils_js_1.parseCssNumber)(css.borderTopWidth) : 0), (0, styleUtils_js_1.parseCssNumber)(css.paddingRight) +
            (css.borderRightStyle != 'none' ? (0, styleUtils_js_1.parseCssNumber)(css.borderRightWidth) : 0), (0, styleUtils_js_1.parseCssNumber)(css.paddingBottom) +
            (css.borderBottomStyle != 'none' ? (0, styleUtils_js_1.parseCssNumber)(css.borderBottomWidth) : 0));
    }
    /**
    ...
    getPreferredPageSize(bounds, width, height) {
        ...
        const page = new Rectangle_js_1.default(0, 0, Math.ceil(fmt.width * ps), Math.ceil(fmt.height * ps));
        ...
        return new Rectangle_js_1.default(0, 0, hCount * page.width + 2 + tr.x, vCount * page.height + 2 + tr.y);
    }
    /**
    ...
    createEdgeHandler(state, edgeStyle) {
        const handlerKind = EdgeStyleRegistry_js_1.EdgeStyleRegistry.getHandlerKind(edgeStyle);
        switch (handlerKind) {
            case 'elbow':
    ...
    refresh(cell = null) {
        ...
        this.view.validate();
        this.sizeDidChange();
        this.fireEvent(new EventObject_js_1.default(InternalEvent_js_1.default.REFRESH));
    }
    /**
    ...
    center(horizontal = true, vertical = true, cx = 0.5, cy = 0.5) {
        const container = this.container;
        const _hasScrollbars = (0, styleUtils_js_1.hasScrollbars)(this.container);
    ...
    isOrthogonal(edge) {
        ...
        if (!(0, utils_js_1.isNullish)(orthogonal)) {
            return orthogonal;
        }
        // fallback when the orthogonal style is not defined
        const edgeStyle = this.view.getEdgeStyle(edge);
        return EdgeStyleRegistry_js_1.EdgeStyleRegistry.isOrthogonal(edgeStyle);
    }
    /*****************************************************************************
...
(0, _graph_mixins_apply_js_1.applyGraphMixins)(AbstractGraph);

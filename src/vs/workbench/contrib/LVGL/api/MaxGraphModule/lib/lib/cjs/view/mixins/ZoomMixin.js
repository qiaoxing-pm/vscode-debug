...
exports.ZoomMixin = {
    ...
    zoom(factor, center) {
        ...
        if (this.keepSelectionVisibleOnZoom && state != null) {
            const rect = new Rectangle_js_1.default(state.x * factor, state.y * factor, state.width * factor, state.height * factor);
            ...
            const _hasScrollbars = (0, styleUtils_js_1.hasScrollbars)(this.getContainer());
    ...
    zoomToRect(rect) {
        ...
        if (!(0, styleUtils_js_1.hasScrollbars)(this.getContainer())) {

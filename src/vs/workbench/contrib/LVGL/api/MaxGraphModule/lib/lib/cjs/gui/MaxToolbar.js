...
const MaxPopupMenu_js_1 = __importDefault(require("./MaxPopupMenu.js"));
 ...
 * @category GUI
 */
class MaxToolbar extends EventSource_js_1.default {
    ...
    addItem(title = null, icon = null, funct = null, pressedIcon = null, style = null, factoryMethod = null) {
        ...
        if (title != null) {
            if (icon != null) {
                ...
                (0, domUtils_js_1.write)(img, title);
            }
        }
        this.container.appendChild(img);
        // Invokes the function on a click on the toolbar item
        if (funct != null) {
            InternalEvent_js_1.default.addListener(img, 'click', funct);
            if (Client_js_1.default.IS_TOUCH) {
                InternalEvent_js_1.default.addListener(img, 'touchend', funct);
            }
        }
        ...
        InternalEvent_js_1.default.addGestureListeners(img, (evt) => {
            if (pressedIcon != null) {
            ...
            if (factoryMethod) {
                if (this.menu == null) {
                    this.menu = new MaxPopupMenu_js_1.default();
                ...
                if (last != img) {
                    ...
                    const point = new Point_js_1.default(img.offsetLeft, img.offsetTop + img.offsetHeight);
        ...
        InternalEvent_js_1.default.addListener(img, 'mouseout', mouseHandler);
        return img;
    }
    /**
    ...
    addActionCombo(title, style) {
        ...
        InternalEvent_js_1.default.addListener(select, 'change', (evt) => {
    ...
    addOption(combo, title, value = null) {
        ...
        (0, domUtils_js_1.writeln)(option, title);
    ...
    addSwitchMode(title, icon, funct, pressedIcon = null, style = 'mxToolbarMode') {
        ...
        InternalEvent_js_1.default.addListener(img, 'click', (evt) => {
            ...
            this.fireEvent(new EventObject_js_1.default(InternalEvent_js_1.default.SELECT));
            funct();
        });
        this.container.appendChild(img);
    ...
    addMode(title = null, icon = null, funct, pressedIcon, style = null, toggle = false) {
        ...
        if (this.enabled && toggle) {
            ...
            InternalEvent_js_1.default.addListener(img, 'dblclick', (evt) => {
                this.selectMode(img, funct);
                this.noReset = true;
            });
            if (this.defaultMode == null) {
    ...
    selectMode(domNode, funct = null) {
        if (this.selectedMode != domNode) {
            ...
            this.fireEvent(new EventObject_js_1.default(InternalEvent_js_1.default.SELECT, { function: funct }));
        }
    }
    /**
     ...
     */
    addBreak() {
        (0, domUtils_js_1.br)(this.container);
    }
    /**
     ...
     */
    destroy() {
        InternalEvent_js_1.default.release(this.container);
        // @ts-ignore
        this.container = null;
        this.defaultMode = null;
        this.defaultFunction = null;

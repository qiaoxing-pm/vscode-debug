...
import type { KeyboardEventListener, Listenable, MouseEventListener } from '../../types.js';
...
declare class InternalEvent {
     ...
     * default behaviour.
     */
    static redirectMouseEvents(node: Listenable, graph: AbstractGraph, state?: CellState | ((evt: Event) => CellState | null) | null, down?: MouseEventListener | null, move?: MouseEventListener | null, up?: MouseEventListener | null, dblClick?: MouseEventListener | null): void;
    /**

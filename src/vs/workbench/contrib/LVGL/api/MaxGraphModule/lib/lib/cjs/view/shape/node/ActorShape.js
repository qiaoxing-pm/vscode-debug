 ...
 */
class ActorShape extends Shape_js_1.default {
    constructor(bounds = null, fill = Constants_js_1.NONE, stroke = Constants_js_1.NONE, strokeWidth = 1) {
        super();
        this.bounds = bounds;
        this.fill = fill;
        this.stroke = stroke;

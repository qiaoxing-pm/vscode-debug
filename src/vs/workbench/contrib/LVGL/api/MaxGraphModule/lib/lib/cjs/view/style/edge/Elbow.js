...
exports.ElbowConnector = void 0;
const SideToSide_js_1 = require("./SideToSide.js");
const TopToBottom_js_1 = require("./TopToBottom.js");
/**
...
const ElbowConnector = (state, source, target, points, result) => {
    ...
    if (!horizontal && (vertical || state.style.elbow === 'vertical')) {
        (0, TopToBottom_js_1.TopToBottom)(state, source, target, points, result);
    }
    else {
        (0, SideToSide_js_1.SideToSide)(state, source, target, points, result);
    }
};
exports.ElbowConnector = ElbowConnector;

 ...
 */
class CellCodec extends ObjectCodec_js_1.default {
    constructor() {
        super(new Cell_js_1.default(), ['children', 'edges', 'overlays', 'mxTransient'], ['parent', 'source', 'target']);
        this.setName('Cell');
    }
    /**
    ...
    isExcluded(obj, attr, value, isWrite) {
        return (super.isExcluded(obj, attr, value, isWrite) ||
            (isWrite && attr === 'value' && (0, utils_js_1.isElement)(value)));
    }
    /**
     * Encodes a {@link Cell} and wraps the XML up inside the XML of the user object (inversion).
     */
    afterEncode(enc, obj, node) {
        if ((0, utils_js_1.isElement)(obj.value)) {
            // Wraps the graphical annotation up in the user object (inversion)
            // by putting the result of the default encoding into a clone of the
            // user object (node type 1) and returning this cloned user object.
            const tmp = node;
            node = (0, domUtils_js_1.importNode)(enc.document, obj.value, true);
    ...
    beforeDecode(dec, node, obj) {
        ...
        if (node.nodeName !== classname) {
            ...
            if (tmp != null && tmp.parentNode === node) {
                (0, StringUtils_js_1.removeWhitespace)(tmp, true);
                (0, StringUtils_js_1.removeWhitespace)(tmp, false);
            ...
            for (let i = 0; i < this.idrefs.length; i += 1) {
                ...
                if (ref != null) {
                    ...
                    if (object == null) {
                        ...
                        if (element != null) {
                            const decoder = CodecRegistry_js_1.default.codecs[element.nodeName] || this;

...
class Effects {
    ...
    static animateChanges(graph, changes, done) {
        ...
        const animate = () => {
            ...
            for (let i = 0; i < changes.length; i += 1) {
                ...
                if (change instanceof GeometryChange_js_1.default ||
                    change instanceof TerminalChange_js_1.default ||
                    change instanceof ValueChange_js_1.default ||
                    change instanceof ChildChange_js_1.default ||
                    change instanceof StyleChange_js_1.default) {
                    // @ts-ignore
                    const state = graph.getView().getState(change.cell || change.child, false);
                    if (state != null) {
                        isRequired = true;
                        if (change.constructor !== GeometryChange_js_1.default || change.cell.isEdge()) {
                            (0, styleUtils_js_1.setOpacity)(state.shape.node, (100 * step) / maxStep);
                        }
                        else {
    ...
    static cascadeOpacity(graph, cell, opacity) {
        ...
        for (let i = 0; i < childCount; i += 1) {
            ...
            if (childState != null) {
                (0, styleUtils_js_1.setOpacity)(childState.shape.node, opacity);
        ...
        if (edges != null) {
            for (let i = 0; i < edges.length; i += 1) {
                ...
                if (edgeState != null) {
                    (0, styleUtils_js_1.setOpacity)(edgeState.shape.node, opacity);
                }
            }
        }
    }
    ...
    static fadeOut(node, from, remove, step, delay, isEnabled) {
        ...
        (0, styleUtils_js_1.setOpacity)(node, opacity);

...
const MedianCellSorter_js_1 = __importDefault(require("../util/MedianCellSorter.js"));
/**
 ...
 * @category Layout
 */
class MedianHybridCrossingReduction extends HierarchicalLayoutStage_js_1.default {
    constructor(layout) {
        super();
        /**
    ...
    medianRank(rankValue, downwardSweep) {
        ...
        for (let i = 0; i < numCellsForRank; i += 1) {
            ...
            const sorterEntry = new MedianCellSorter_js_1.default();
        ...
        medianValues.sort(new MedianCellSorter_js_1.default().compare);
...
exports.default = MedianHybridCrossingReduction;

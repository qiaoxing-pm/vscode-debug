...
const CellHighlight_js_1 = __importDefault(require("./CellHighlight.js"));
 ...
 */
class CellMarker extends EventSource_js_1.default {
    /**
     ...
     */
    constructor(graph, validColor = Constants_js_1.DEFAULT_VALID_COLOR, invalidColor = Constants_js_1.DEFAULT_INVALID_COLOR, hotspot = Constants_js_1.DEFAULT_HOTSPOT) {
        super();
        /**
         ...
         */
        this.hotspot = Constants_js_1.DEFAULT_HOTSPOT;
        /**
         ...
         */
        this.currentColor = Constants_js_1.NONE;
        /**
        ...
        this.highlight = new CellHighlight_js_1.default(graph);
    }
    /**
    ...
    setCurrentState(state, me, color) {
        ...
        if (state !== this.markedState || color !== this.currentColor) {
            ...
            if (state && this.currentColor !== Constants_js_1.NONE) {
    ...
    mark() {
        ...
        this.fireEvent(new EventObject_js_1.default(InternalEvent_js_1.default.MARK, 'state', this.markedState));
    }
    /**
    ...
    intersects(state, me) {
        ...
        if (this.hotspotEnabled) {
            return (0, mathUtils_js_1.intersectsHotspot)(state, x, y, this.hotspot, Constants_js_1.MIN_HOTSPOT_SIZE, Constants_js_1.MAX_HOTSPOT_SIZE);
        }
        return true;
    }
    /**

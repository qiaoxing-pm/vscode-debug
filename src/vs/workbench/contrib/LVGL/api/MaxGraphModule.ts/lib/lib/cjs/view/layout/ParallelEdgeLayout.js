 ...
 * @category Layout
 */
class ParallelEdgeLayout extends GraphLayout_js_1.default {
    constructor(graph) {
        super(graph);
        /**
    ...
    getEdgeId(edge) {
        ...
        if (src != null && trg != null) {
            src = ObjectIdentity_js_1.default.get(src);
            trg = ObjectIdentity_js_1.default.get(trg);
    ...
    route(edge, x, y) {
        if (this.graph.isCellMovable(edge)) {
            this.setEdgePoints(edge, [new Point_js_1.default(x, y)]);
        }
    }
}
exports.default = ParallelEdgeLayout;

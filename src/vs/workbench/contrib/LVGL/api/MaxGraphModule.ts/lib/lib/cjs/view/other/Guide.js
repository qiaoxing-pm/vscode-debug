...
class Guide {
    ...
    createGuideShape(horizontal = false) {
        ...
        const guide = new PolylineShape_js_1.default([], Constants_js_1.GUIDE_COLOR, Constants_js_1.GUIDE_STROKEWIDTH);
        guide.isDashed = true;
        return guide;
    }
    /**
        ...
        if ((this.horizontal || this.vertical) && bounds) {
            ...
            if (!overrideX && this.guideX) {
                ...
                if (minY !== null && maxY !== null) {
                    this.guideX.points = [new Point_js_1.default(valueX, minY), new Point_js_1.default(valueX, maxY)];
                }
                else {
                    this.guideX.points = [
                        new Point_js_1.default(valueX, -this.graph.getPanDy()),
                        new Point_js_1.default(valueX, c.scrollHeight - 3 - this.graph.getPanDy()),
                    ];
                }
            ...
            if (!overrideY && this.guideY != null) {
                ...
                if (minX != null && maxX != null && valueY !== null) {
                    this.guideY.points = [new Point_js_1.default(minX, valueY), new Point_js_1.default(maxX, valueY)];
                }
                else if (valueY !== null) {
                    this.guideY.points = [
                        new Point_js_1.default(-this.graph.getPanDx(), valueY),
                        new Point_js_1.default(c.scrollWidth - 3 - this.graph.getPanDx(), valueY),
                    ];
                }
    ...
    getGuideColor(state, horizontal) {
        return Constants_js_1.GUIDE_COLOR;
    }
    /**
     * Hides all current guides.
     */

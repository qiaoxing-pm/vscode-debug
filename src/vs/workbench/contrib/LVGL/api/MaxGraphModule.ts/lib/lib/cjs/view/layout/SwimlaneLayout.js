...
const GraphLayout_js_1 = __importDefault(require("./GraphLayout.js"));
...
const SwimlaneModel_js_1 = __importDefault(require("./hierarchical/SwimlaneModel.js"));
const ObjectIdentity_js_1 = __importDefault(require("../../util/ObjectIdentity.js"));
const SwimlaneOrdering_js_1 = __importDefault(require("./hierarchical/SwimlaneOrdering.js"));
const MedianHybridCrossingReduction_js_1 = __importDefault(require("./hierarchical/MedianHybridCrossingReduction.js"));
const CoordinateAssignment_js_1 = __importDefault(require("./hierarchical/CoordinateAssignment.js"));
/**
 * A hierarchical layout algorithm.
 *
 * @category Layout
 */
class SwimlaneLayout extends GraphLayout_js_1.default {
    /**
    ...
    constructor(graph, orientation, deterministic = true) {
         ...
         */
        this.edgeStyle = HierarchicalEdgeStyle_js_1.default.POLYLINE;
        ...
        for (let i = 0; i < swimlanes.length; i += 1) {
            ...
            if (geo != null) {
                ...
                if (layoutBounds == null) {
                    layoutBounds = new Rectangle_js_1.default(0, childrenY, 0, maxChildrenY - childrenY);
                }
                else {
    ...
    run(parent) {
        ...
        this.model = new SwimlaneModel_js_1.default(this, tmp, this.roots, parent, this.tightenToSource);
    ...
    filterDescendants(cell, result) {
        ...
        if (cell.isVertex() &&
            ...
            cell.isVisible()) {
            result[ObjectIdentity_js_1.default.get(cell)] = cell;
        }
    ...
    traverse({ vertex, directed, allVertices, currentComp, hierarchyVertices, filledVertexSet, swimlaneIndex, }) {
        if (vertex != null && allVertices != null) {
            ...
            const vertexID = ObjectIdentity_js_1.default.get(vertex);
     ...
     */
    cycleStage(parent) {
        const cycleStage = new SwimlaneOrdering_js_1.default(this);
    ...
    crossingStage(parent) {
        const crossingStage = new MedianHybridCrossingReduction_js_1.default(this);
    ...
    placementStage(initialX, parent) {
        const placementStage = new CoordinateAssignment_js_1.default(this, this.intraCellSpacing, this.interRankCellSpacing, this.orientation, initialX, this.parallelEdgeSpacing);
        placementStage.fineTuning = this.fineTuning;
        placementStage.execute(parent);
        return placementStage.limitX + this.interHierarchySpacing;
    }
}
exports.default = SwimlaneLayout;

...
exports.EditorKeyHandlerCodec = void 0;
const ObjectCodec_js_1 = __importDefault(require("../../ObjectCodec.js"));
const EditorKeyHandler_js_1 = __importDefault(require("../../../editor/EditorKeyHandler.js"));
/**
 ...
 */
class EditorKeyHandlerCodec extends ObjectCodec_js_1.default {
    constructor() {
        super(new EditorKeyHandler_js_1.default());
    }
    /**
     * Returns `null`.
     */

 ...
 * @category Layout
 */
class EdgeLabelLayout extends GraphLayout_js_1.default {
    ...
    avoid(edge, vertex) {
        ...
        if ((0, mathUtils_js_1.intersects)(labRect, vertex)) {
            ...
            if (g != null) {
                ...
                if (g.offset != null) {
                    ...
                    g.offset = new Point_js_1.default(dx, dy);
                }
...
exports.default = EdgeLabelLayout;

...
class KeyHandler {
    ...
    constructor(graph, target = null) {
        ...
        if (graph != null) {
            ...
            InternalEvent_js_1.default.addListener(this.target, 'keydown', this.keydownHandler);
        }
    }
    /**
     ...
     */
    getFunction(evt) {
        if (evt != null && !(0, EventUtils_js_1.isAltDown)(evt)) {
            if (this.isControlDown(evt)) {
                if ((0, EventUtils_js_1.isShiftDown)(evt)) {
    ...
    isGraphEvent(evt) {
        ...
        return this.graph ? (0, domUtils_js_1.isAncestorNode)(this.graph.container, source) : false;
    }
    /**
    ...
    onDestroy() {
        if (this.target != null && this.keydownHandler != null) {
            InternalEvent_js_1.default.removeListener(this.target, 'keydown', this.keydownHandler);
            this.keydownHandler = null;
        }
        this.target = null;
    }

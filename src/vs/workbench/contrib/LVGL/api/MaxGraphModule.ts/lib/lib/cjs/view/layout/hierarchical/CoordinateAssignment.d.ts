...
declare class CoordinateAssignment extends HierarchicalLayoutStage {
     ...
     */
    constructor(layout: HierarchicalLayout | SwimlaneLayout, intraCellSpacing: number | undefined, interRankCellSpacing: number | undefined, orientation: DirectionValue, initialX: number, parallelEdgeSpacing?: number);
    /**
     ...
     * @param model an internal model of the hierarchical layout
     */
    initialCoords(facade: AbstractGraph, model: GraphHierarchyModel): void;
    /**
     ...
     * @param model an internal model of the hierarchical layout
     */
    rankCoordinates(rankValue: number, graph: AbstractGraph, model: GraphHierarchyModel): void;
    /**
     ...
     * @param model an internal model of the hierarchical layout
     */
    calculateWidestRank(graph: AbstractGraph, model: GraphHierarchyModel): void;
    /**
     ...
     * @param model an internal model of the hierarchical layout
     */
    minPath(graph: AbstractGraph, model: GraphHierarchyModel): void;
    /**
     ...
     * @param model the layout model
     */
    setCellLocations(graph: AbstractGraph, model: GraphHierarchyModel): void;
    /**

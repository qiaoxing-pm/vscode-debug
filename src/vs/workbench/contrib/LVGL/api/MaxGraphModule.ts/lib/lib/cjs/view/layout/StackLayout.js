 ...
 * @category Layout
 */
class StackLayout extends GraphLayout_js_1.default {
    ...
    getParentSize(parent) {
        ...
        if (this.graph.container != null &&
            ...
            pgeo = new Geometry_js_1.default(0, 0, width, height);
        }
        return pgeo;
    }
    /**
    ...
    execute(parent) {
        if (parent != null) {
            ...
            if (this.graph.isSwimlane(parent)) {
                ...
                let start = style.startSize ?? Constants_js_1.DEFAULT_STARTSIZE;

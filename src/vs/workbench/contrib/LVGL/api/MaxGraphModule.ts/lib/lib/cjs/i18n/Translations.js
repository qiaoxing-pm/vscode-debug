...
exports.TranslationsAsI18n = void 0;
...
Translations.isLanguageSupported = (lan) => {
    const languages = config_js_1.TranslationsConfig.getLanguages();
    if (languages) {
...
Translations.getSpecialBundle = (basename, lan) => {
    if (!config_js_1.TranslationsConfig.getLanguages() || !Translations.isLanguageSupported(lan)) {
    ...
    if (Translations.loadSpecialBundle &&
        Translations.isLanguageSupported(lan) &&
        lan != config_js_1.TranslationsConfig.getDefaultLanguage()) {
...
Translations.add = (basename = null, lan = null, callback = null) => {
    lan ?? (lan = config_js_1.TranslationsConfig.getLanguage()?.toLowerCase() ?? Constants_js_1.NONE);
    if (!(0, utils_js_1.isNullish)(basename) && lan !== Constants_js_1.NONE) {
        ...
        const loadSpecialBundle = () => {
            if (specialBundle != null) {
                if (callback) {
                    (0, requestUtils_js_1.get)(specialBundle, (req) => {
                    ...
                    try {
                        const req = (0, requestUtils_js_1.load)(specialBundle);
                        if (req.isReady()) {
                            Translations.parse(req.getText());
                        }
                    }
        ...
        if (defaultBundle != null) {
            if (callback) {
                (0, requestUtils_js_1.get)(defaultBundle, (req) => {
                    Translations.parse(req.getText());
                    loadSpecialBundle();
                }, () => {
                    loadSpecialBundle();
                ...
                try {
                    const req = (0, requestUtils_js_1.load)(defaultBundle);
                    if (req.isReady()) {
                        Translations.parse(req.getText());
                    }
                    loadSpecialBundle();

...
exports.mxGeometryCodec = void 0;
 ...
 */
class mxGeometryCodec extends ObjectCodec_js_1.default {
    getName() {
        return 'mxGeometry';
    }
    constructor() {
        super(new Geometry_js_1.default());
    }
    afterDecode(dec, node, obj) {
        ...
        if (originalPoints) {
            ...
            for (const pointInput of originalPoints) {
                ...
                points.push(new Point_js_1.default(rawPoint.x, rawPoint.y));
            }
            obj.points = points;
        }
        return obj;

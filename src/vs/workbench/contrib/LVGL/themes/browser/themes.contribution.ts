...
const assertViewIcon = registerIcon(
	'themes-view-icon',
	Codicon.themes,
	localize('themesViewIcon', 'View icon of the themes view.')
);

Registry.as<IViewsRegistry>(Extensions.ViewsRegistry).registerViews(
	[
		{
			id: 'workbench.view.themes',
			name: localize2('themesView.name', "主题"),
			containerIcon: assertViewIcon,
			ctorDescriptor: new SyncDescriptor(ThemesView),

...
import { AlignValue, ColorValue, DirectionValue, Gradient, GradientMap, OverflowValue, TextDirectionValue, VAlignValue } from '../../types.js';
/**
...
declare class SvgCanvas2D extends AbstractCanvas2D {
     ...
     */
    static createCss: (w: number, h: number, align: AlignValue, valign: VAlignValue, wrap: boolean, overflow: string, clip: boolean, bg: ColorValue | null, border: ColorValue | null, flex: string, block: string, scale: number, callback: (dx: number, dy: number, flex: string, item: string, block: string, ofl: string) => void) => void;
    /**

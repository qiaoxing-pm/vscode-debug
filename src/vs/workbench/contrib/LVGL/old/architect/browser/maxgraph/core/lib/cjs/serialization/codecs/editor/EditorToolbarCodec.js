...
exports.EditorToolbarCodec = void 0;
const ObjectCodec_js_1 = __importDefault(require("../../ObjectCodec.js"));
const EditorToolbar_js_1 = require("../../../editor/EditorToolbar.js");
 ...
 */
class EditorToolbarCodec extends ObjectCodec_js_1.default {
    constructor() {
        super(new EditorToolbar_js_1.EditorToolbar());
    }
    /**
     * Returns `null`.
     */
                    ...
                    if (!this.processInclude(dec, node, into)) {
                        if (node.nodeName === 'separator') {
                            ...
                            if (action != null) {
                                ...
                                funct = EditorToolbarCodec.allowEval ? (0, utils_js_1.doEval)(text) : null;
                                ...
                                if (text != null && text.length > 0 && EditorToolbarCodec.allowEval) {
                                    insertFunction = (0, utils_js_1.doEval)(text);
                                }
                                elt = into.addPrototype(as, icon, cell, pressedIcon, insertFunction, toggle);
                            }
                            else {
                                const children = (0, domUtils_js_1.getChildNodes)(node);
                                if (children.length > 0) {
                                    if (icon == null) {
                                        ...
                                        const create = () => {
                                            ...
                                            config_js_1.GlobalConfig.logger.warn(`Template ${template} not found`);
                                            return null;
                                        };
                                        ...
                                        InternalEvent_js_1.default.addListener(select, 'change', () => {
                                            into.toolbar.selectMode(img, (evt) => {
                                                const pt = (0, styleUtils_js_1.convertPoint)(editor.graph.container, (0, EventUtils_js_1.getClientX)(evt), (0, EventUtils_js_1.getClientY)(evt));

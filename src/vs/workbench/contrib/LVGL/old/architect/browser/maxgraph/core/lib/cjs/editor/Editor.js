...
const EditorPopupMenu_js_1 = __importDefault(require("./EditorPopupMenu.js"));
const UndoManager_js_1 = __importDefault(require("../view/undoable_changes/UndoManager.js"));
const EditorKeyHandler_js_1 = __importDefault(require("./EditorKeyHandler.js"));
const EventSource_js_1 = __importDefault(require("../view/event/EventSource.js"));
const Client_js_1 = __importDefault(require("../Client.js"));
const CompactTreeLayout_js_1 = __importDefault(require("../view/layout/CompactTreeLayout.js"));
const EditorToolbar_js_1 = require("./EditorToolbar.js");
const StackLayout_js_1 = __importDefault(require("../view/layout/StackLayout.js"));
...
const ModelXmlSerializer_js_1 = require("../serialization/ModelXmlSerializer.js");
const MaxWindow_js_1 = __importDefault(require("../gui/MaxWindow.js"));
const MaxForm_js_1 = __importDefault(require("../gui/MaxForm.js"));
const Outline_js_1 = __importDefault(require("../view/other/Outline.js"));
const Cell_js_1 = __importDefault(require("../view/cell/Cell.js"));
const Geometry_js_1 = __importDefault(require("../view/geometry/Geometry.js"));
const Constants_js_1 = require("../util/Constants.js");
const Graph_js_1 = require("../view/Graph.js");
const SwimlaneManager_js_1 = __importDefault(require("../view/layout/SwimlaneManager.js"));
const LayoutManager_js_1 = __importDefault(require("../view/layout/LayoutManager.js"));
...
const PrintPreview_js_1 = __importDefault(require("../view/other/PrintPreview.js"));
const Clipboard_js_1 = __importDefault(require("../util/Clipboard.js"));
const MaxLog_js_1 = __importDefault(require("../gui/MaxLog.js"));
 ...
 * @category Editor
 */
class Editor extends EventSource_js_1.default {
    /**
    ...
    constructor(config) {
         ...
         * @default 'askZoom'
         */
        this.askZoomResource = (0, i18n_utils_js_1.isI18nEnabled)() ? 'askZoom' : '';
        // =====================================================================================
         ...
         * @default 'lastSaved'.
         */
        this.lastSavedResource = (0, i18n_utils_js_1.isI18nEnabled)() ? 'lastSaved' : '';
        /**
         * Specifies the resource key for the current file info. If the resource for
         * this key does not exist then the value is used as the error message. Default is 'currentFile'.
         * @default 'currentFile'
         */
        this.currentFileResource = (0, i18n_utils_js_1.isI18nEnabled)() ? 'currentFile' : '';
        /**
         ...
         * @default 'properties'
         */
        this.propertiesResource = (0, i18n_utils_js_1.isI18nEnabled)() ? 'properties' : '';
        /**
         ...
         * @default 'tasks'
         */
        this.tasksResource = (0, i18n_utils_js_1.isI18nEnabled)() ? 'tasks' : '';
        /**
         ...
         * @default 'help'
         */
        this.helpResource = (0, i18n_utils_js_1.isI18nEnabled)() ? 'help' : '';
        /**
         ...
         * @default 'outline'
         */
        this.outlineResource = (0, i18n_utils_js_1.isI18nEnabled)() ? 'outline' : '';
        /**
        ...
        if (document.body) {
            ...
            this.cycleAttributeValues = [];
            this.popupHandler = new EditorPopupMenu_js_1.default();
            this.undoManager = new UndoManager_js_1.default();
            // Creates the graph and toolbar without the containers
            this.graph = this.createGraph();
            this.toolbar = this.createToolbar();
            // Creates the global key handler (requires graph instance)
            this.keyHandler = new EditorKeyHandler_js_1.default(this);
    ...
    addActions() {
        ...
        this.addAction('print', (editor) => {
            const preview = new PrintPreview_js_1.default(editor.graph, 1);
            preview.open();
        });
        this.addAction('show', (editor) => {
            (0, printUtils_js_1.show)(editor.graph, null, 10, 10);
        });
        this.addAction('exportImage', (editor) => {
            const url = editor.getUrlImage();
            if (url == null || Client_js_1.default.IS_LOCAL) {
                editor.execute('show');
            }
            else {
                const node = (0, xmlUtils_js_1.getViewXml)(editor.graph, 1);
                const xml = (0, xmlUtils_js_1.getXml)(node, '\n');
                (0, requestUtils_js_1.submit)(url, `${editor.postParameterName}=${encodeURIComponent(xml)}`, document, '_blank');
            }
        });
        ...
        this.addAction('cut', (editor) => {
            if (editor.graph.isEnabled()) {
                Clipboard_js_1.default.cut(editor.graph);
            }
        });
        this.addAction('copy', (editor) => {
            if (editor.graph.isEnabled()) {
                Clipboard_js_1.default.copy(editor.graph);
            }
        });
        this.addAction('paste', (editor) => {
            if (editor.graph.isEnabled()) {
                Clipboard_js_1.default.paste(editor.graph);
            }
        });
        ...
        this.addAction('bold', (editor) => {
            if (editor.graph.isEnabled()) {
                editor.graph.toggleCellStyleFlags('fontStyle', Constants_js_1.FONT_STYLE_MASK.BOLD);
            }
        });
        this.addAction('italic', (editor) => {
            if (editor.graph.isEnabled()) {
                editor.graph.toggleCellStyleFlags('fontStyle', Constants_js_1.FONT_STYLE_MASK.ITALIC);
            }
        });
        this.addAction('underline', (editor) => {
            if (editor.graph.isEnabled()) {
                editor.graph.toggleCellStyleFlags('fontStyle', Constants_js_1.FONT_STYLE_MASK.UNDERLINE);
            }
        });
        ...
        this.addAction('zoom', (editor) => {
            ...
            const preInput = prompt((0, i18n_utils_js_1.translate)(editor.askZoomResource) || editor.askZoomResource, String(current));
            if (preInput) {
        ...
        this.addAction('toggleTasks', (editor) => {
            if (!(0, utils_js_1.isNullish)(editor.tasks)) {
        ...
        this.addAction('toggleHelp', (editor) => {
            if (!(0, utils_js_1.isNullish)(editor.help)) {
        ...
        this.addAction('toggleOutline', (editor) => {
            if ((0, utils_js_1.isNullish)(editor.outline)) {
                editor.showOutline();
            }
            else {
        ...
        this.addAction('toggleConsole', (editor) => {
            MaxLog_js_1.default.setVisible(!MaxLog_js_1.default.isVisible());
        });
    }
    /**
    ...
    configure(node) {
        if (node) {
            ...
            const dec = new Codec_js_1.default(node.ownerDocument);
    ...
    execute(actionname, cell = null, evt = null) {
        ...
        if (action) {
            try {
                ...
                (0, guiUtils_js_1.error)(`Cannot execute ${actionname}: ${e.message}`, 280, true);
                throw e;
            }
        }
        else {
            (0, guiUtils_js_1.error)(`Cannot find action ${actionname}`, 280, true);
        }
    }
    /**
    ...
    createSwimlaneManager(graph) {
        const swimlaneMgr = new SwimlaneManager_js_1.default(graph, false);
    ...
    createLayoutManager(graph) {
        const layoutMgr = new LayoutManager_js_1.default(graph);
    ...
    setGraphContainer(container) {
        if (!this.graph.container && container) {
            ...
            this.rubberband = new RubberBandHandler_js_1.default(this.graph);
            // Disables the context menu
            if (this.disableContextMenu) {
                InternalEvent_js_1.default.disableContextMenu(container);
            }
        }
    }
    /**
    ...
    installDblClickHandler(graph) {
        ...
        graph.addListener(InternalEvent_js_1.default.DOUBLE_CLICK, (sender, evt) => {
            const cell = evt.getProperty('cell');
    ...
    installUndoHandler(graph) {
        ...
        graph.getDataModel().addListener(InternalEvent_js_1.default.UNDO, listener);
        graph.getView().addListener(InternalEvent_js_1.default.UNDO, listener);
        // Keeps the selection state in sync
        const undoHandler = (sender, evt) => {
            const { changes } = evt.getProperty('edit');
            graph.setSelectionCells(graph.getSelectionCellsForChanges(changes));
        };
        this.undoManager.addListener(InternalEvent_js_1.default.UNDO, undoHandler);
        this.undoManager.addListener(InternalEvent_js_1.default.REDO, undoHandler);
    }
    /**
    ...
    installDrillHandler(graph) {
        const listener = (sender) => {
            this.fireEvent(new EventObject_js_1.default(InternalEvent_js_1.default.ROOT));
        };
        graph.getView().addListener(InternalEvent_js_1.default.DOWN, listener);
        graph.getView().addListener(InternalEvent_js_1.default.UP, listener);
    }
    /**
    ...
    installChangeHandler(graph) {
        const listener = (sender, evt) => {
            ...
            for (const change of changes) {
                if (change instanceof RootChange_js_1.default ||
                    (change instanceof ValueChange_js_1.default && change.cell === this.graph.model.root) ||
                    (change instanceof CellAttributeChange_js_1.default && change.cell === this.graph.model.root)) {
                    this.fireEvent(new EventObject_js_1.default(InternalEvent_js_1.default.ROOT));
                    break;
                }
            }
        };
        graph.getDataModel().addListener(InternalEvent_js_1.default.CHANGE, listener);
    }
    /**
    ...
    createDiagramLayout() {
        ...
        const layout = new StackLayout_js_1.default(this.graph, !this.horizontalFlow, this.swimlaneSpacing, 2 * gs, 2 * gs);
    ...
    createSwimlaneLayout() {
        return new CompactTreeLayout_js_1.default(this.graph, this.horizontalFlow);
    }
    /**
     ...
     */
    createToolbar() {
        return new EditorToolbar_js_1.EditorToolbar(null, this);
    }
    /**
    ...
    setStatusContainer(container) {
        if (!this.status && container) {
            ...
            this.addListener(InternalEvent_js_1.default.SAVE, () => {
                const timestamp = new Date().toLocaleString();
                this.setStatus(`${(0, i18n_utils_js_1.translate)(this.lastSavedResource) || this.lastSavedResource}: ${timestamp}`);
            });
            // Updates the statusbar to display the filename when new files are opened
            this.addListener(InternalEvent_js_1.default.OPEN, () => {
                this.setStatus(`${(0, i18n_utils_js_1.translate)(this.currentFileResource) || this.currentFileResource}: ${this.filename}`);
            });
        }
    }
    /**
     ...
     */
    setStatus(message) {
        if (this.status && !(0, utils_js_1.isNullish)(message)) {
    ...
    setTitleContainer(container) {
        this.addListener(InternalEvent_js_1.default.ROOT, (sender) => {
    ...
    treeLayout(cell, horizontal) {
        if (cell) {
            const layout = new CompactTreeLayout_js_1.default(this.graph, horizontal);
            layout.execute(cell);
        }
    }
    /**
     ...
     */
    createGroup() {
        return (0, cellArrayUtils_js_1.cloneCell)(this.defaultGroup);
    }
    /**
     ...
     */
    open(filename) {
        if (!(0, utils_js_1.isNullish)(filename)) {
            const xml = (0, requestUtils_js_1.load)(filename).getXml();
            this.readGraphModel(xml.documentElement);
            this.filename = filename;
            this.fireEvent(new EventObject_js_1.default(InternalEvent_js_1.default.OPEN, { filename }));
        }
    }
    /**
     ...
     */
    readGraphModel(node) {
        new ModelXmlSerializer_js_1.ModelXmlSerializer(this.graph.getDataModel()).import(node);
        this.resetHistory();
    }
    /**
    ...
    save(url = null, linefeed = this.linefeed) {
        ...
        this.fireEvent(new EventObject_js_1.default(InternalEvent_js_1.default.SAVE, { url }));
    }
    /**
    ...
    postDiagram(url, data) {
        ...
        (0, requestUtils_js_1.post)(url, `${this.postParameterName}=${data}`, (req) => {
            this.fireEvent(new EventObject_js_1.default(InternalEvent_js_1.default.POST, { request: req, url, data }));
        });
    }
    /**
    ...
    writeGraphModel(linefeed) {
        return new ModelXmlSerializer_js_1.ModelXmlSerializer(this.graph.getDataModel()).export({ pretty: false });
    }
    /**
    ...
    showProperties(cell = null) {
        ...
        if (cell) {
            ...
            if (node) {
                ...
                this.properties = new MaxWindow_js_1.default((0, i18n_utils_js_1.translate)(this.propertiesResource) || this.propertiesResource, node, x, y, this.propertiesWidth, this.propertiesHeight, false);
    ...
    createProperties(cell) {
        ...
        if ((0, domUtils_js_1.isNode)(value)) {
            // Creates a form for the user object inside
            // the cell
            const form = new MaxForm_js_1.default('properties');
            ...
            const okFunction = () => {
                ...
                try {
                    ...
                    for (let i = 0; i < attrs.length; i += 1) {
                        const edit = new CellAttributeChange_js_1.default(cell, attrs[i].nodeName, texts[i].value);
                        model.execute(edit);
                    }
    ...
    showTasks() {
        if (this.tasks == null) {
            ...
            const wnd = new MaxWindow_js_1.default((0, i18n_utils_js_1.translate)(this.tasksResource) || this.tasksResource, div, w - 220, this.tasksTop, 200);
            ...
            const funct = (sender) => {
                InternalEvent_js_1.default.release(div);
                div.innerHTML = '';
                this.createTasks(div);
            };
            this.graph.getDataModel().addListener(InternalEvent_js_1.default.CHANGE, funct);
            this.graph.getSelectionModel().addListener(InternalEvent_js_1.default.CHANGE, funct);
            this.graph.addListener(InternalEvent_js_1.default.ROOT, funct);
    ...
    showHelp(tasks = null) {
        if (this.help == null) {
            ...
            frame.setAttribute('src', ((0, i18n_utils_js_1.translate)('urlHelp') || this.urlHelp));
            ...
            const wnd = new MaxWindow_js_1.default((0, i18n_utils_js_1.translate)(this.helpResource) || this.helpResource, frame, (w - this.helpWidth) / 2, (h - this.helpHeight) / 3, this.helpWidth, this.helpHeight);
            ...
            if (Client_js_1.default.IS_NS) {
                ...
                wnd.addListener(InternalEvent_js_1.default.RESIZE_END, handler);
                wnd.addListener(InternalEvent_js_1.default.MAXIMIZE, handler);
                wnd.addListener(InternalEvent_js_1.default.NORMALIZE, handler);
                wnd.addListener(InternalEvent_js_1.default.SHOW, handler);
            }
            this.help = wnd;
        }
    ...
    showOutline() {
        ...
        if (create) {
            ...
            const wnd = new MaxWindow_js_1.default((0, i18n_utils_js_1.translate)(this.outlineResource) || this.outlineResource, div, 600, 480, 200, 200, false);
            // Creates the outline in the specified div
            // and links it to the existing graph
            const outline = new Outline_js_1.default(this.graph, div);
            wnd.setClosable(true);
            wnd.setResizable(true);
            wnd.destroyOnClose = false;
            wnd.addListener(InternalEvent_js_1.default.RESIZE_END, () => {
                outline.update();
            });
            this.outline = wnd;
    ...
    createEdge(source, target) {
        ...
        if (this.defaultEdge != null) {
            e = (0, cellArrayUtils_js_1.cloneCell)(this.defaultEdge);
        }
        else {
            e = new Cell_js_1.default('');
            e.setEdge(true);
            const geo = new Geometry_js_1.default();
            geo.relative = true;
            e.setGeometry(geo);
        }
     ...
     */
    cycleAttribute(cell) {
        if (!(0, utils_js_1.isNullish)(this.cycleAttributeName)) {
    ...
    addVertex(parent, vertex, x, y) {
        ...
        this.fireEvent(new EventObject_js_1.default(InternalEvent_js_1.default.BEFORE_ADD_VERTEX, { vertex: vertex, parent: parent }));
        model.beginUpdate();
        try {
            vertex = this.graph.addCell(vertex, parent);
            if (vertex) {
                this.graph.constrainChild(vertex);
                this.fireEvent(new EventObject_js_1.default(InternalEvent_js_1.default.ADD_VERTEX, { vertex: vertex }));
            }
        }
        finally {
            model.endUpdate();
        ...
        if (vertex != null) {
            ...
            this.fireEvent(new EventObject_js_1.default(InternalEvent_js_1.default.AFTER_ADD_VERTEX, { vertex: vertex }));
        }
        return vertex;
    }
    /**

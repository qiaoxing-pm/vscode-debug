...
exports.printScreen = exports.show = exports.getScaleForPageCount = void 0;
...
const styleUtils_js_1 = require("./styleUtils.js");
/**
...
const getScaleForPageCount = (pageCount, graph, pageFormat, border = 0) => {
    ...
    pageFormat =
        pageFormat != null ? pageFormat : new Rectangle_js_1.default(...Constants_js_1.PAGE_FORMAT_A4_PORTRAIT);
...
exports.getScaleForPageCount = getScaleForPageCount;
/**
...
const show = (graph, doc = null, x0 = 0, y0 = 0, w = null, h = null) => {
    ...
    for (let i = 0; i < base.length; i += 1) {
        doc.writeln((0, domUtils_js_1.getOuterHtml)(base[i]));
    }
    const links = document.getElementsByTagName('link');
    for (let i = 0; i < links.length; i += 1) {
        doc.writeln((0, domUtils_js_1.getOuterHtml)(links[i]));
    }
    const styles = document.getElementsByTagName('style');
    for (let i = 0; i < styles.length; i += 1) {
        doc.writeln((0, domUtils_js_1.getOuterHtml)(styles[i]));
    }
    ...
    if (graph.container && graph.view.drawPane) {
        ...
        (0, styleUtils_js_1.removeCursors)(doc.body);
    }
    return doc;
};
exports.show = show;
...
const printScreen = (graph) => {
    ...
    if (!wnd)
        return;
    const bounds = graph.getGraphBounds();
    (0, exports.show)(graph, wnd.document);
    const print = () => {
        wnd.focus();
        wnd.print();
        wnd.close();
